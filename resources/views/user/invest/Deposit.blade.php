                            ...
                            <div data-v-decd48ac="" id="content" class="content-scroll">
                                <div data-v-2848a4de="" data-v-decd48ac="" class="container">
                                    <div data-v-2848a4de="" data-v-decd48ac="" class="it biBox">
                                        <div data-v-2848a4de="" data-v-decd48ac="" class="cname">Select currency
                                        </div>
                                        <div data-v-2848a4de="" data-v-decd48ac="" class="valMob">
                                            <div data-v-2848a4de="" data-v-decd48ac="" class="inp flex">
                                                <div data-v-2848a4de="" data-v-decd48ac="" class="ico"><img
                                                        ...
                                                        alt=""></div>
                                                <div data-v-2848a4de="" data-v-decd48ac="" class="flex1"> USDT
                                                </div>
                                    ...
                                    <div data-v-2848a4de="" data-v-decd48ac="" class="it newBox">
                                        <div data-v-2848a4de="" data-v-decd48ac="" class="it biBox">
                                            ...
                                            <div data-v-2848a4de="" data-v-decd48ac="" class="valMob">
                                                <div data-v-2848a4de="" data-v-decd48ac="" class="inp flex">
                                                    ...
                                                    <input type="text" type="hidden" id="networkInput"
                                                        value="BNB SMART CHAIN(BEP20) " name="network_type"
                                                        class="flex1" />
                                        ...
                                        <div data-v-2848a4de="" data-v-decd48ac="" class="qrbox">
                                            <div data-v-2848a4de="" data-v-decd48ac="" class="m"><img
                                                    data-v-2848a4de="" data-v-decd48ac="" src="{{ $qrCodeLink }}"
                                                    id="qrCodeImage" style=" width: 224px;height: 220px;">
                                            </div>
                                        </div>
                                    ...
                                    <div data-v-2848a4de="" data-v-decd48ac="" class="it tipBox">
                                        <div data-v-2848a4de="" data-v-decd48ac="" class="cname"><img
                                                data-v-2848a4de="" data-v-decd48ac=""
                                        ...
                                        <div data-v-2848a4de="" data-v-decd48ac="" class="p">
                                            <p>
                                                1. The minimum deposit amount is 30 USDT. If the amount is lower than the latest
                                                amount, it will not be available.
                                            </p>
                                            <p>2. The recharge address is USDT-BEP20 and USDT-TRC20 , please check carefully before recharging.
                                            </p>
                                        ...
                                        <div data-v-2848a4de="" class="modal-list">
                                            <div data-v-2848a4de="" class="list-info">
                                                ...
                                                <div data-v-2848a4de="" class="info"
                                                    onclick="getCurrencyDetails('trc20'); selectCurrency('trc20', this);">
                                            ...
                                            <div data-v-2848a4de="" class="modal-list">
                                                <div data-v-2848a4de="" class="list-info">
                                                    <div data-v-2848a4de="" class="img"><img data-v-2848a4de=""
                                                            src="{{asset('static/img/b86a98eb340999b410c339853a4c1f2d.png')}}"
                                                            alt=""></div>
                                                    <div data-v-2848a4de="" class="info"
                                                        onclick="getCurrencyDetails('bep20'); selectCurrency('bep20', this);">
                                                        <div data-v-2848a4de="">BNB SMART CHAIN(BEP20)</div>
                                                        <p data-v-2848a4de="">Expected arrival time ≈1 minutes</p>
                                                        <p data-v-2848a4de=""> Minimum deposit ≥1 USDT </p>
                                                    </div>
                                            ...
                                            <div data-v-2848a4de="" class="modal-btn isact0"
                                                onclick="confirmSelection()"> OK </div>
                                        </div>
...
<style>
    ...
    padding: 7px;
        ...
        <script>
            let selectedCurrency = ''; // Make sure this is declared globally
            ...
            function selectCurrency(currency, element) {
                ...
                // Show tick mark for selected item
            ...
            function confirmSelection() {
                ...
                if (selectedCurrency === 'trc20') {
                    input.value = 'TRX(TRC20)';
                } else if (selectedCurrency === 'bep20') {
                    input.value = 'BNB SMART CHAIN(BEP20)';
                }
            ...
            function getCurrencyDetails(currency) {
                console.log("Fetching address for:", currency); // Add this log

                fetch(`/user/get-address-details/${currency}`)
