...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('') }}static/css/chunk-d551bc9e.2aeb364f.css">
    <script charset="utf-8" src="/js1744307594169/chunk-d551bc9e.6bee488d.1744307594169.chunk.js"></script>
...
<body class="main_en">
    ...
    <style>
        ...
        ul li[data-v-3f44a7a0]:last-child {
            border: 1px solid #6c6c6c;
        }
        ...
        <div data-v-6302a7bf="">
            <div data-v-6302a7bf="" class="van-pull-refresh">
                <div class="van-pull-refresh__track" style="transition-duration: 0ms;">
                    ...
                    <div data-v-decd48ac="" data-v-3f44a7a0="" class="page">
                        <div data-v-decd48ac="" class="headers on">
                            <div data-v-29c52665="" data-v-3f44a7a0="" class="head head0" data-v-decd48ac="">
                                <div data-v-29c52665="" class="container flex">
                                    <a href="{{ route('user.dashboard') }}">
                                        <div data-v-155cb6a1="" class="back">
                                    ...
                                    <!---->
                                    <div data-v-29c52665="" class="name tac">Language switching</div>
                        ...
                        <div data-v-decd48ac="" id="scroll" class="content-container" style="padding-top: 44px;">
                            <div data-v-decd48ac="" id="content" class="content-scroll">
                                <div data-v-3f44a7a0="" data-v-decd48ac="" class="container">
                                    <div data-v-3f44a7a0="" data-v-decd48ac="" class="list">
                                        <div data-v-3f44a7a0="" role="radiogroup" class="van-radio-group"
                                            data-v-decd48ac="">
                                            <ul data-v-3f44a7a0="">

                                                @if (is_array($languages) || is_object($languages))
                                                    @foreach ($languages as $value)
                                                        <li data-v-3f44a7a0="" class="db langSel" data-response="{{$value->code}}">
                                                            <div data-v-3f44a7a0="" class="flexs"> <span class="fi fi-{{ $value->code == 'en' ? 'ai' : ($value->code == 'fa' ? 'ir' : $value->code) }}"> </span> 
                                                                 &nbsp; {{ $value->name }}</div>

                                                            <div data-v-3f44a7a0="" class="s"
                                                                id="radio-box-{{ $value->id }}">

                                                                @if (session('lang') == $value->code)
                                                                    <div data-v-3f44a7a0="" role="radio"
                                                                        tabindex="0" aria-checked="true"
                                                                        class="van-radio">
                                                                        <div
                                                                            class="van-radio__icon van-radio__icon--round van-radio__icon--checked">
                                                                            <i class="van-icon van-icon-success"
                                                                                style="border-color: rgb(11, 83, 180); background-color: rgb(11, 83, 180);"><!----></i>
                                                                        </div>
                                                                    </div>
                                                                @endif
                                                            </div>
