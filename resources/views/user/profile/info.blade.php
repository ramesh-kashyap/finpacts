                                ...
                                <div data-v-20c16f3c="" data-v-decd48ac="" class="container">
                                    <ul data-v-20c16f3c="" data-v-decd48ac="" class="item">
                                        ...
                                        <li data-v-20c16f3c="" data-v-decd48ac="" class="it flex">
                                            <div class="flex1">Account</div>
                                            <div class="str">
                                                <span id="userNameDisplay" onclick="enableEdit()" style="cursor: pointer;">
                                                    {{ Auth::user()->name }}
                                                </span>
                                                <input type="text" id="userNameInput" value="{{ Auth::user()->name }}" 
                                                       style="display:none; background: transparent;border:1px solid #ccc; border-radius:5px; padding:2px;" 
                                                       onblur="updateUserName()" />
                                            </div>
                                        </li>

                                        <li data-v-20c16f3c="" data-v-decd48ac="" class="it flex">
                                            <div data-v-20c16f3c="" data-v-decd48ac="" class="flex1">Phone</div>
                                            <div data-v-20c16f3c="" data-v-decd48ac="" class="str">+{{Auth::user()->dialCode}}{{Auth::user()->phone}}
                                        ...
                                        <li data-v-20c16f3c="" data-v-decd48ac="" class="it flex">
                                            ...
                                            <div data-v-20c16f3c="" data-v-decd48ac="" class="str"><span
                                                    data-v-20c16f3c=""
                                                    data-v-decd48ac="" style="    text-transform: lowercase;">{{Auth::user()->email}}</span></div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            function updateUserName() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            $('#userNameDisplay').text(newName).show();
                            $('#userNameInput').hide();
                            iziToast.success({
